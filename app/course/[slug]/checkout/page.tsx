      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="lg:grid lg:grid-cols-[1fr_1fr] lg:gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                驗證碼 <span className="text-amber-500">*</span>
              </label>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <input
                  ...
                  placeholder="請輸入圖中驗證碼"
                  className="flex-1 min-w-[120px] max-w-[180px] px-3 py-2 rounded-lg border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  autoComplete="off"
                  aria-label="驗證碼"
                />
              </div>
