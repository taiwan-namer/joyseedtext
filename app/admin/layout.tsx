...
export default function AdminLayout({
   ...
   * （與總站後台「preview 裸頁」一致；含子路徑以保險。）
   */
  if (pathname === "/admin/layout/preview" || pathname.startsWith("/admin/layout/preview/")) {
    return <div className="min-h-dvh min-w-0 bg-gray-100">{children}</div>;
  }
  return (
