...
const SIDEBAR_MENU = [
  ...
  { label: "我的賣場", href: "#", icon: Store },
  {
    label: "會員項",
    icon: Users,
    open: false,
    children: [{ label: "B會員功能管理", href: "#" }],
  },
  {
    label: "介紹項",
    icon: FileText,
    open: false,
    children: [{ label: "D關於我們", href: "#" }],
  },
  {
    label: "功能項",
    icon: Package,
    open: true,
    children: [
      { label: "F商品管理區", href: "/admin", active: true, sub: ["新增課程", "價格組合設定"] },
      { label: "G功能應用項目", href: "#", sub: [] },
      { label: "H行銷項目", href: "#", sub: [] },
    ],
  },
  {
    label: "訂單綜合項",
